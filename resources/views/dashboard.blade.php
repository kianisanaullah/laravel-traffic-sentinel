...
<head>
    ...
    {{-- Favicon --}}
    <link rel="icon" type="image/svg+xml" href="{{ asset('vendor/traffic-sentinel/favicon.svg') }}">
    <link rel="icon" type="image/png" href="{{ asset('vendor/traffic-sentinel/favicon.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('vendor/traffic-sentinel/favicon.png') }}">
    ...
    <style>
        ...
        /* Light theme override toggle (optional) */
    ...
    <div class="ts-header p-3 p-md-4 mb-3">
        <div class="d-flex flex-column flex-md-row gap-3 align-items-md-center justify-content-between">
            ...
            <div class="d-flex align-items-center gap-3">
                <img src="{{ asset('vendor/traffic-sentinel/logo.svg') }}"
                     alt="Traffic Sentinel"
                     height="44"
                     class="ts-logo">

                <div>
                    <div class="ts-title h4 mb-1">Traffic Sentinel</div>
                    <div class="ts-subtitle">Visitors + Bots monitoring</div>
                </div>
            </div>
...
<script>
    // Simple theme toggle (stores preference)
    (function () {
